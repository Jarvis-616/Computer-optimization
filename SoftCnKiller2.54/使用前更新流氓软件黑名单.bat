...
title 更新流氓软件黑名单
cd /d "%~dp0"
echo 请选择更新源，默认使用1、CodeChina更新。
echo.&choice /C 12 /T 5 /D 1 /M "1、使用CodeChina仓库更新 2、使用Gitee仓库更新"
if errorlevel 2 goto gitee
if errorlevel 1 goto codechina
:codechina
...
echo.&echo 使用CodeChina更新...
wscript.exe -e:vbs data\CodeChina更新名单.vbs
exit
